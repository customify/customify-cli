package com.customify.shared.responses_data_format;
...
public class WinnersDataFormat implements Serializable {
    ...
    public WinnersDataFormat(int customerId, String firstName, String lastName, String email, float noPoints, String winingDate, int code) {
